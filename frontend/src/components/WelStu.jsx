...
function WelStu(props) {

    console.log(props.studentUserName);
                ...
                <table style={{width: "100%" , marginLeft: "50px"}}>          
                 ...
                 <tr>
                        <td className="left_bigbox" style={{width: "700px",height: "500px" }} >
                            <Link to={"/StuWel"} state={{name: props.studentUserName}}><button style={{height:"80px",width:"200px", borderRadius:"20px",backgroundColor:"#004aad",color:"white", marginLeft:"250px"}}>Continue</button></Link>
